...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <h2 class="mb-0">
                <i class="bi bi-plus-circle me-2"></i>Tambah Bank Sampah
            </h2>
        </div>
    </div>
    ...
    <div class="card admin-card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.bank-sampah.store') }}" enctype="multipart/form-data">
                @csrf
...
<script>
    ...
    @if(old('latitude') && old('longitude'))
        locationInfo.style.display = 'block';
        selectedLocationName.textContent = locationInput.value || 'Lokasi dipilih';
    @endif
</script>
<style>
    #locationSuggestions {
