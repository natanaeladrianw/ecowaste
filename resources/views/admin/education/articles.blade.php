    ...
    <div class="container-fluid">
        ...
        <div
            ...
            <a href="{{ route('admin.education.articles.create') }}" class="btn btn-success">
                <i class="bi bi-plus-circle me-1"></i><span class="d-none d-md-inline">Tambah Artikel</span><span
            ...
            @forelse($articles as $article)
                <div class="col-12 col-md-6 col-lg-4 mb-4">
                    <div class="card admin-card h-100">
                        @if($article->image)
                            <img src="{{ Str::startsWith($article->image, 'uploads/') ? asset($article->image) : asset('storage/' . $article->image) }}"
                        ...
                        <div class="card-footer bg-white">
                            <div class="d-flex gap-2">
                                ...
                                <button type="button"
                                    ...
                                    data-bs-toggle="modal" data-bs-target="#deleteArticleModal{{ $article->id }}">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p>Apakah Anda yakin ingin menghapus artikel
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('admin.education.articles.destroy', $article->id) }}"
