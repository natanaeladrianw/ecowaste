    ...
    <div class="container-fluid">
        ...
        <div
            ...
            <a href="{{ route('admin.education.challenges.create') }}" class="btn btn-success">
                <i class="bi bi-plus-circle me-1"></i><span class="d-none d-md-inline">Tambah Challenge</span><span
                                ...
                                <div class="mb-2">
                                    ...
                                    @if($challenge->target_amount)
                                        <span class="badge bg-warning text-dark mb-1">
                                            ...
                                            {{ number_format($challenge->target_amount) }} {{ $challenge->target_unit ?? 'kg' }}
                                        </span>
                                    @endif
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            @if($challenge->target_amount)
                                                <span class="badge bg-warning text-dark mb-1">
                                                    <i class="bi bi-bullseye me-1"></i>Target:
                                                    {{ number_format($challenge->target_amount) }}
                                                    {{ $challenge->target_unit ?? 'kg' }}
                                                </span>
                                            @endif
                                            <span class="badge bg-success mb-1">
                                                <i
                                                    class="bi bi-star-fill me-1"></i>{{ number_format($challenge->points_reward) }}
                                                Poin
                                            </span>
                                        </div>
                        ...
                        <div class="card-footer bg-white">
                            <div class="d-flex gap-2">
                                ...
                                <button type="button"
                                    ...
                                    data-bs-toggle="modal" data-bs-target="#deleteChallengeModal{{ $challenge->id }}">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p>Apakah Anda yakin ingin menghapus challenge
                                                    <strong>{{ $challenge->title }}</strong>?</p>
                                                <div class="alert alert-danger mb-0">
                                                    <i class="bi bi-exclamation-triangle me-2"></i>
                                                    <strong>Peringatan:</strong> Tindakan ini tidak dapat dibatalkan. Data
                                                    challenge akan dihapus secara permanen.
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('admin.education.challenges.destroy', $challenge->id) }}"
