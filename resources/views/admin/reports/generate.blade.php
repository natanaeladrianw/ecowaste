    ...
    <div class="container-fluid">
        ...
        <div
            ...
            <form action="{{ route('admin.reports.export') }}" method="GET" class="d-inline">
                ...
                <button type="submit" name="format" value="pdf" class="btn btn-danger ms-1">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p class="mb-0"><strong>Dari:</strong>
                            {{ \Carbon\Carbon::parse($reportData['start_date'])->format('d/m/Y') }}</p>
                    </div>
                    <div class="col-md-6">
                        <p class="mb-1"><strong>Total Data:</strong> {{ $reportData['total_transactions'] }} transaksi</p>
                        <p class="mb-0"><strong>Sampai:</strong>
                            {{ \Carbon\Carbon::parse($reportData['end_date'])->format('d/m/Y') }}</p>
                    </div>
                </div>
            </div>
        </div>
