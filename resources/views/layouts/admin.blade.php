        ...
        * {
        ...
        @media (max-width: 767.98px) {
            ...
            .table {
                font-size: 0.8rem;
                width: 100%;
                min-width: 600px; /* Minimum width untuk menjaga struktur tabel */
                margin-bottom: 0;
            }
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="sidebarOffcanvas" aria-labelledby="sidebarOffcanvasLabel">
        ...
        <div class="offcanvas-body p-0">
            <div class="user-info">
                ...
                <div class="logout-icon" onclick="document.querySelector('.offcanvas-body .logout-form').submit();" title="Logout">
                    <i class="bi bi-box-arrow-right"></i>
                </div>
            </div>
