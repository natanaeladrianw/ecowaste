        ...
        <div class="rewards-list">
            @foreach($rewards as $reward)
                <div class="card mb-3 shadow-sm" style="transition: all 0.3s ease;">
                    ...
                    <div class="card-body" data-bs-toggle="collapse" data-bs-target="#reward-detail-{{ $reward->id }}" aria-expanded="false" style="cursor: pointer;">
                    ...
                    <div class="collapse" id="reward-detail-{{ $reward->id }}">
                        <div class="card-body border-top bg-light">
                            ...
                            <div class="mt-3 pt-3 border-top">
                                <form action="{{ route('user.points.rewards.claim', $reward->id) }}" method="POST" class="d-inline w-100" id="claimForm{{ $reward->id }}">
                                    @csrf
                                    ...
                                    @else
                                        <button type="button" 
                                            ...
                                            @if($user->total_points < $reward->points_required)
                                                <i class="bi bi-x-circle me-1"></i>Poin Tidak Cukup (Butuh {{ number_format($reward->points_required) }} Poin)
