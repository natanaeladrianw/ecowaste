                ...
                <div class="card-body p-3">
                    <div class="d-flex justify-content-between align-items-start">
                        <div class="flex-grow-1">
                            <h6 class="card-subtitle mb-1" style="font-size: 0.75rem; opacity: 0.9;">Total Sampah Hari Ini</h6>
                            <h4 class="card-title mb-0" style="font-size: 1.5rem; font-weight: 600;">
                                {{ number_format($totalKg, 2) }} kg
                            </h4>
                        </div>
                        <i class="bi bi-trash" style="font-size: 2rem; opacity: 0.3; flex-shrink: 0; margin-left: 0.5rem; align-self: flex-start;"></i>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card stat-card text-white" style="background: linear-gradient(135deg, #007bff, #0056b3);">
                <div class="card-body p-3">
                    <div class="d-flex justify-content-between align-items-start">
                        ...
                        <i class="bi bi-award" style="font-size: 2rem; opacity: 0.3; flex-shrink: 0; margin-left: 0.5rem; align-self: flex-start;"></i>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-6 col-md-4">
            <div class="card stat-card text-white" style="background: linear-gradient(135deg, #ffc107, #ff9800);">
                <div class="card-body p-3">
                    <div class="d-flex justify-content-between align-items-start">
                        <div class="flex-grow-1">
                            <h6 class="card-subtitle mb-1" style="font-size: 0.75rem; opacity: 0.9;">Transaksi Hari Ini</h6>
                            <h4 class="card-title mb-0" style="font-size: 1.5rem; font-weight: 600;">
                                {{ number_format($totalTransactions) }}
                            </h4>
                        </div>
                        <i class="bi bi-list-check" style="font-size: 2rem; opacity: 0.3; flex-shrink: 0; margin-left: 0.5rem; align-self: flex-start;"></i>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        @foreach($wastes as $waste)
                            <tr>
                                ...
                                <td class="text-center">
                                    {{ number_format($waste->unit === 'gram' ? $waste->amount / 1000 : $waste->amount, 2) }} {{ $waste->unit }}
                                </td>
                                <td class="text-center">
